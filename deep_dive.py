...
LANDSCAPE_QUERIES = [
    "LinkedIn B2B Institute research report paid social 2023 2024 2025",
    "WARC effectiveness case study paid social digital advertising",
    "Effie award case study digital advertising paid social effectiveness",
    "Think with Google paid social B2B case study results",
    "IPA effectiveness case digital advertising brand performance",
    "Meta business success story B2B enterprise paid social case study",
    "Reddit advertising case study B2B technology brand",
    "AdExchanger paid social research measurement attribution 2024 2025",
    "Digiday brand paid social strategy case study 2024 2025",
    "Marketing Brew paid social advertising insight research 2024 2025",
    "LinkedIn ads case study B2B demand generation results data",
    "enterprise technology paid social advertising strategy case study",
    "Dell HP Lenovo Apple advertising paid social 2024 2025",
    "paid social measurement incrementality attribution research 2024 2025",
    "B2B buyer behavior enterprise technology digital research 2024 2025",
]
...
<table width="620" cellpadding="0" cellspacing="0" style="max-width:620px;width:100%;">
  ...
  <tr><td style="background:linear-gradient(135deg,#064E3B 0%,#065F46 55%,#047857 100%);
...
def main():
    ...
    print("\n[Phase 2] Selecting best topic based on available material...")
    selection_prompt = TOPIC_SELECTION_PROMPT.format(
        today=today,
        landscape_results=landscape_raw[:12000],  # trim to fit context
    ...
    deep_raw = search_batch(queries, max_results=5, label="Deep")

    # Phase 4: Compile
    print("\n[Phase 4] Compiling operator memo...")
    deep_prompt = DEEP_DIVE_PROMPT.format(
        today=today,
        topic=topic,
        focus_angle=focus_angle,
        deep_results=deep_raw,
        landscape_results=landscape_raw[:6000],
    )
    data = call_groq(deep_prompt, max_tokens=4000)
